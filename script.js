...
document.addEventListener('DOMContentLoaded', function() {
  ...
  setupInfoModalCloseOnOutsideClick();
  setupInfoModalCloseOnEscape();
  setupHoverEffects();
...
function setupInfoModalCloseOnOutsideClick() {
  const infoModals = ['termsModal', 'privacyModal', 'refundModal'];
...
// Close info modals on escape key
function setupInfoModalCloseOnEscape() {
  document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape') {
      // Close any open info modal
      const infoModals = ['termsModal', 'privacyModal', 'refundModal'];
      infoModals.forEach(modalId => {
        const modal = document.getElementById(modalId);
