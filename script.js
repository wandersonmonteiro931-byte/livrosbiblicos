...
function choosePremium() {
    // Redireciona para WhatsApp com mensagem do pacote premium
    const whatsappUrl = "https://wa.me/5511999999999?text=Olá! Quero comprar o Pacote Premium de Livros para Colorir por R$ 14,90";
    window.open(whatsappUrl, '_blank');
    closeUpsellModal();
}

function chooseBasic() {
    // Redireciona para WhatsApp com mensagem do pacote básico
    const whatsappUrl = "https://wa.me/5511999999999?text=Olá! Quero comprar o Pacote Básico de Livros para Colorir por R$ 10,00";
    window.open(whatsappUrl, '_blank');
    closeUpsellModal();
}
...
window.choosePremium = choosePremium;
window.chooseBasic = chooseBasic;
